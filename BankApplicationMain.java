...
public class BankApplicationMain {
    ...
    public static void main(String[] args) {
        ...
        loginUsers.add(new LoginUser("admin", "admin123", "admin")); // Admin
        loginUsers.add(new LoginUser("user1", "user123", "user"));   // User 1
            ...
            try {
                ...
                switch (adminChoice) {
                    case 1:
                        ...
                        // Automatically create a LoginUser for the new account
